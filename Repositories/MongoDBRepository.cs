...
namespace DotnetCoreRESTAPI.Repositories
{
    public class MongoDBRepository : IRepository
    {
        ...
        public async Task<IEnumerable<MobilePhone>> GetMobilePhonesAsync() => (await collection.FindAsync(new BsonDocument())).ToEnumerable();

        public async Task UpdateMobilePhoneAsync(MobilePhone mobilePhone) => await collection.ReplaceOneAsync(filterBuilder.Eq(i => i.Id, mobilePhone.Id), mobilePhone);
    }
}